  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-3xl p-8 border border-white border-opacity-20">
      ...
      <div className="flex gap-4">
        <button 
          onClick={onNext}
          className="flex-1 bg-spotify-green hover:bg-green-600 text-black font-bold py-3 px-6 rounded-full transition-all duration-300 hover:-translate-y-1"
        >
          Next Song
        </button>
        <button 
          onClick={onSkip}
          className="flex-1 bg-white bg-opacity-10 hover:bg-opacity-20 border border-white border-opacity-30 font-bold py-3 px-6 rounded-full transition-all duration-300"
        >
          Skip
        </button>
      </div>
